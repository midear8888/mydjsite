...
class Hospital(models.Model):
    ...
    h_name = models.CharField(max_length=50, null=False, unique=True)  # 医院名
    h_add = models.CharField(max_length=255, null=False)  # 医院地址
    username = models.CharField(max_length=20, null=False, unique=True)  # 把用户的手机号码作为登录密码
    password = models.CharField(max_length=50, null=False)  # 登录密码
